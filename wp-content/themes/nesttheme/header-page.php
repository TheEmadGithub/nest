                        ...
                        <div class="main-categori-wrap d-none d-lg-block-">
                            ...
                            <div class="categories-dropdown-wrap categories-dropdown-active-large font-heading">
                                <div class="d-flex categori-dropdown-inner">
                                    <ul>
                                        <li>
                                            <a href="shop-grid-right.html"> <img src="<?php bloginfo('template_directory');?>/assets/imgs/theme/icons/category-1.svg" alt="" />Milks and Dairies</a>
                                        </li>
                                        <li>
                                            <a href="shop-grid-right.html"> <img src="<?php bloginfo('template_directory');?>/assets/imgs/theme/icons/category-2.svg" alt="" />Clothing & beauty</a>
                                        </li>
                                        <li>
                                            <a href="shop-grid-right.html"> <img src="<?php bloginfo('template_directory');?>/assets/imgs/theme/icons/category-3.svg" alt="" />Pet Foods & Toy</a>
                                        </li>
                                        <li>
                                            <a href="shop-grid-right.html"> <img src="<?php bloginfo('template_directory');?>/assets/imgs/theme/icons/category-4.svg" alt="" />Baking material</a>
                                        </li>
                                        <li>
                                            <a href="shop-grid-right.html"> <img src="<?php bloginfo('template_directory');?>/assets/imgs/theme/icons/category-5.svg" alt="" />Fresh Fruit</a>
                                        </li>
                                    </ul>
                                    <ul class="end">
                                        <li>
                                            <a href="shop-grid-right.html"> <img src="<?php bloginfo('template_directory');?>/assets/imgs/theme/icons/category-6.svg" alt="" />Wines & Drinks</a>
                                        </li>
                                        <li>
                                            <a href="shop-grid-right.html"> <img src="<?php bloginfo('template_directory');?>/assets/imgs/theme/icons/category-7.svg" alt="" />Fresh Seafood</a>
                                        </li>
                                        <li>
                                            <a href="shop-grid-right.html"> <img src="<?php bloginfo('template_directory');?>/assets/imgs/theme/icons/category-8.svg" alt="" />Fast food</a>
                                        </li>
                                        <li>
                                            <a href="shop-grid-right.html"> <img src="<?php bloginfo('template_directory');?>/assets/imgs/theme/icons/category-9.svg" alt="" />Vegetables</a>
                                        </li>
                                        <li>
                                            <a href="shop-grid-right.html"> <img src="<?php bloginfo('template_directory');?>/assets/imgs/theme/icons/category-10.svg" alt="" />Bread and Juice</a>
                                        </li>
                                    </ul>
                                </div>
                        ...
                        <div class="main-menu main-menu-padding-1 main-menu-lh-2 d-none d-lg-block font-heading">
                            <nav>
                                <ul class="d-none">
                                    ...
                                    <li>
                                        <a href="vendors-grid.html">Vendors <i class="fi-rs-angle-down  d-none"></i></a>
                                        <ul class="sub-menu  d-none">
                                    ...
                                    <li class="position-static d-none">
                                        <a href="#">Mega menu <i class="fi-rs-angle-down  d-none"></i></a>
                                        <ul class="mega-menu">
                                            ...
                                            <li class="sub-mega-menu sub-mega-menu-width-34">
                                                <div class="menu-banner-wrap">
                                                    <a href="shop-product-right.html"><img src="<?php bloginfo('template_directory');?>/assets/imgs/banner/banner-menu.png" alt="Nest" /></a>
                                    ...
                                    <li>
                                        <a href="blog-category-big.html">Blog <i class="fi-rs-angle-down  d-none"></i></a>
                                        <ul class="sub-menu d-none">
                            ...
                            <div class="header-action-icon-2">
                                ...
                                <div class="cart-dropdown-wrap cart-dropdown-hm2">
                                    <ul>
                                        ...
                                        <li>
                                            <div class="shopping-cart-img">
                                                <a href="shop-product-right.html"><img alt="Nest" src="<?php bloginfo('template_directory');?>/assets/imgs/shop/thumbnail-4.jpg" /></a>
                                            </div>
                                            <div class="shopping-cart-title">
