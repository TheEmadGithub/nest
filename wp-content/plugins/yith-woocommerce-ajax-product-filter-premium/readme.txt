...
= 5.10.0 - Released on 8 April 2025 =

* New: support for WordPress 6.8
* Update: YITH plugin framework

= 5.9.0 - Released on 18 March 2025 =
...
= 5.8.0 - Released on 12 Febrary 2025 =
...
* Update: YITH plugin framework
* Tweak: filter terms count even if no layared nav is applied
...
= 4.30.1 - Released on 30 January 2024 =

* Update: YITH plugin framework
* Dev: added new filter yith_wcan_hide_out_of_stock_products
...
= 4.29.0 - Released on 21 December 2023 =
